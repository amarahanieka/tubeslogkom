...
beliequipment :- 
    ...
    X is Length,
    random(0,X,Hasil),
    equSwordsman(Hasil,Dapat,Val,Jenis),
    addItem(Dapat),
    identitas(Job, Level, Attack, Defense, EXP, HP, Gold),
    (Jenis==armor->(NewDefense is (Defense+Val));(NewDefense is Defense),!),
    Y is (Gold-150),
    retract(identitas(Job, Level, Attack, Defense, EXP, HP, Gold)),
    asserta(identitas(Job, Level, Attack, NewDefense, EXP, HP, Y)),
...
beliequipment :- 
    ...
    X is Length,
    random(0,X,Hasil),
    equArcher(Hasil,Dapat,Val,Jenis),
    addItem(Dapat),
    identitas(Job, Level, Attack, Defense, EXP, HP, Gold),
    (Jenis==armor->(NewDefense is (Defense+Val));(NewDefense is Defense),!),
    Y is (Gold-150),
